...
class DSInputs:
    ...
    def __init__(self) -> None:
        self.primary = wpilib.simulation.XboxControllerSim(0)
        self.secondary = wpilib.simulation.XboxControllerSim(1)

    def fuzz(self) -> None:
        fuzz_xbox_gamepad(self.primary)
        fuzz_xbox_gamepad(self.secondary)

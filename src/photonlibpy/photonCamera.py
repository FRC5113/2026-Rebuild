    ...
    def _versionCheck(self) -> None:
        ...
        if remoteUUID is None:
            ...
            if localUUID != remoteUUID:
                ...
                errText = f"Photonlibpy version none (With message UUID {localUUID}) does not match coprocessor version {versionString} (with message UUID {remoteUUID}). Please install photonlibpy version {versionString}, or update your coprocessor to none."
